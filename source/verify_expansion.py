...
numeric=[
 ...
 ('Variograms and kriging','weights 0.25 and 0.75',.25*2+.75*6),
 ('Mineral processing and recovery',None,100*1.6/2),
 ('Mineral processing and recovery','5-tonne concentrate',5*.2),
 ('Mineral processing and recovery','feed is 100 tonnes',100-10),
 ('Mineral processing and recovery','remains in tailings',2-1.6),
...
structured=[
 ('Singular value decomposition',None,[[3,0],[0,0]]),
 ('Lagrange multipliers',None,(2/2,2/2)),
 ('Hessian and curvature',None,[[2,0],[0,2*3]]),
 ('Hessian and curvature','f(x,y)=x²−y²',[[2,0],[0,-2]]),
 ('Convolutional neural networks',None,tuple(a-b for a,b in zip([1,2],[2,3]))),
]
import ast
